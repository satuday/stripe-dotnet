namespace Stripe
{
    ...
    public class ApplePayDomainService : BasicService<StripeApplePayDomain>
    {
        ...
        public virtual StripeDeleted Delete(string domainId, RequestOptions requestOptions = null)
        {
        ...
        public virtual Task<StripeDeleted> DeleteAsync(string domainId, RequestOptions requestOptions = null, CancellationToken cancellationToken = default(CancellationToken))
        {
