namespace Stripe
{
    ...
    public class InvoiceItemService : StripeService
    {
        ...
        public virtual StripeDeleted Delete(string invoiceItemId, RequestOptions requestOptions = null)
        {
        ...
        public virtual async Task<StripeDeleted> DeleteAsync(string invoiceItemId, RequestOptions requestOptions = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            return Mapper<StripeDeleted>.MapFromJson(
