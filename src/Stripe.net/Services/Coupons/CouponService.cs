namespace Stripe
{
    ...
    public class CouponService : StripeService
    {
        ...
        public virtual StripeDeleted Delete(string couponId, RequestOptions requestOptions = null)
        {
        ...
        public virtual async Task<StripeDeleted> DeleteAsync(string couponId, RequestOptions requestOptions = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            return Mapper<StripeDeleted>.MapFromJson(
