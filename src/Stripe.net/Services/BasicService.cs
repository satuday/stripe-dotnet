namespace Stripe
{
    ...
    public abstract class BasicService<EntityReturned> : StripeService
    {
        ...
        public virtual StripeDeleted DeleteEntity(string url, RequestOptions requestOptions, BaseOptions options = null)
        {
        ...
        public async Task<StripeDeleted> DeleteEntityAsync(string url, RequestOptions requestOptions, CancellationToken cancellationToken, BaseOptions options = null)
        {
            return Mapper<StripeDeleted>.MapFromJson(
