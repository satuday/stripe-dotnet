namespace Stripe
{
    ...
    public class EphemeralKeyService : BasicService<StripeEphemeralKey>
    {
        ...
        public virtual StripeDeleted Delete(string keyId, RequestOptions requestOptions = null)
        {
        ...
        public virtual Task<StripeDeleted> DeleteAsync(string keyId, RequestOptions requestOptions = null, CancellationToken cancellationToken = default(CancellationToken))
        {
