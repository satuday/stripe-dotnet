namespace Stripe
{
    ...
    public class SubscriptionItemService : BasicService<StripeSubscriptionItem>
    {
        ...
        public virtual StripeDeleted Delete(string subscriptionItemId, RequestOptions requestOptions = null)
        {
        ...
        public virtual Task<StripeDeleted> DeleteAsync(string subscriptionItemId, RequestOptions requestOptions = null, CancellationToken cancellationToken = default(CancellationToken))
        {
