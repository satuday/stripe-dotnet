namespace Stripe
{
    ...
    public class PlanService : StripeService
    {
        ...
        public virtual StripeDeleted Delete(string planId, RequestOptions requestOptions = null)
        {
        ...
        public virtual async Task<StripeDeleted> DeleteAsync(string planId, RequestOptions requestOptions = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            return Mapper<StripeDeleted>.MapFromJson(
