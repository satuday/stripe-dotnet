namespace Stripe
{
    ...
    public class SkuService : BasicService<StripeSku>
    {
        ...
        public virtual StripeDeleted Delete(string skuId, RequestOptions requestOptions = null)
        {
        ...
        public virtual Task<StripeDeleted> DeleteAsync(string skuId, RequestOptions requestOptions = null, CancellationToken cancellationToken = default(CancellationToken))
        {
