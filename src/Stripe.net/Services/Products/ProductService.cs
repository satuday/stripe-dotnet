namespace Stripe
{
    ...
    public class ProductService : BasicService<StripeProduct>
    {
        ...
        public virtual StripeDeleted Delete(string productId, RequestOptions requestOptions = null)
        {
        ...
        public virtual Task<StripeDeleted> DeleteAsync(string productId, RequestOptions requestOptions = null, CancellationToken cancellationToken = default(CancellationToken))
        {
