namespace Stripe
{
    ...
    public class CustomerService : StripeService
    {
        ...
        public virtual StripeDeleted Delete(string customerId, RequestOptions requestOptions = null)
        {
        ...
        public virtual async Task<StripeDeleted> DeleteAsync(string customerId, RequestOptions requestOptions = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            return Mapper<StripeDeleted>.MapFromJson(
